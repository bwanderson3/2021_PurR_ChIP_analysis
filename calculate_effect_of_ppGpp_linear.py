...
#%%
data_direc = "G:/Shared drives/elon_musk/current/Users/Brent/ChIP-seq/PurR_ChIP_data"
...
#%%
enrich_wt_10_1 = np.divide(chip_wt_10_1,input_wt_10_1)
enrich_wt_00_1 = np.divide(chip_wt_00_1,input_wt_00_1)

enrich_p0_10_1 = np.divide(chip_p0_10_1,input_p0_10_1)
enrich_p0_00_1 = np.divide(chip_p0_00_1,input_p0_00_1)

#%%
enrich_wt_10_2 = np.divide(chip_wt_10_2,input_wt_10_2)
enrich_wt_00_2 = np.divide(chip_wt_00_2,input_wt_00_2)

enrich_p0_10_2 = np.divide(chip_p0_10_2,input_p0_10_2)
enrich_p0_00_2 = np.divide(chip_p0_00_2,input_p0_00_2)

#%%
enrich_wt_10_3 = np.divide(chip_wt_10_3,input_wt_10_3)
enrich_wt_00_3 = np.divide(chip_wt_00_3,input_wt_00_3)

enrich_p0_10_3 = np.divide(chip_p0_10_3,input_p0_10_3)
enrich_p0_00_3 = np.divide(chip_p0_00_3,input_p0_00_3)
...
#%%
np.save('effect_of_ppGpp_linear', effect_of_p)
...
#%%
np.save('C:/Users/civwa/Documents/GitHub/PurR_ChIP_analysis/mean_ppGpp_effect_linear', mean_vals)
np.save('C:/Users/civwa/Documents/GitHub/PurR_ChIP_analysis/sd_ppGpp_effect_linear', sd_vals)
